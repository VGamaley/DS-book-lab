...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', 'rio', 'dbplyr', 'dplyr', 'RSQLite', 'tidyverse', 'tidyr', 'RMySQL', 'RPostgreSQL', 'odbc', 'bigrquery', 'nycflights13', 'DBI', 'ggplot2', 'stringr', 'lubridate', 'hms', 'blob', 'reader', 'tibble', 'purrr', 'desctable', 'GGally', 'corrplot', 'PerformanceAnalytics', 'FactoMineR', 'factoextra', 'funModeling', 'desctable', 'ade4', 'psych', 'smacof', 'WVPlots', 'caret', 'car', 'randomForest', 'caret', 'arules', 'arulesViz', 'fpp', 'fpp2', 'fpp3'
), 'packages.bib')
```
