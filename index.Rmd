...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', 'rio', 'dbplyr', 'dplyr', 'RSQLite', 'tidyverse', 'tidyr', 'RMySQL', 'RPostgreSQL', 'odbc', 'bigrquery', 'nycflights13', 'DBI', 'ggplot2', 'stringr', 'lubridate', 'hms', 'blob', 'reader', 'tibble', 'purrr'
), 'packages.bib')
```
